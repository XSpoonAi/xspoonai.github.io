---
id: spoon_ai
slug: /api-reference/spoon_ai/index.md/index
title: spoon_ai
---
...
* [spoon\_ai.social\_media.discord](#spoon_ai.social_media.discord)
  * [DiscordClient](#spoon_ai.social_media.discord.DiscordClient)
    * [\_\_init\_\_](#spoon_ai.social_media.discord.DiscordClient.__init__)
    * [setup\_handlers](#spoon_ai.social_media.discord.DiscordClient.setup_handlers)
    * [send](#spoon_ai.social_media.discord.DiscordClient.send)
    * [run](#spoon_ai.social_media.discord.DiscordClient.run)
    * [stop](#spoon_ai.social_media.discord.DiscordClient.stop)
* [spoon\_ai.social\_media.email](#spoon_ai.social_media.email)
  * [EmailNotifier](#spoon_ai.social_media.email.EmailNotifier)
    * [send](#spoon_ai.social_media.email.EmailNotifier.send)
* [spoon\_ai.social\_media.telegram](#spoon_ai.social_media.telegram)
* [spoon\_ai.social\_media.twitter](#spoon_ai.social_media.twitter)
  * [TwitterClient](#spoon_ai.social_media.twitter.TwitterClient)
    * [read\_timeline](#spoon_ai.social_media.twitter.TwitterClient.read_timeline)
    * [post\_tweet](#spoon_ai.social_media.twitter.TwitterClient.post_tweet)
    * [reply\_to\_tweet](#spoon_ai.social_media.twitter.TwitterClient.reply_to_tweet)
    * [like\_tweet](#spoon_ai.social_media.twitter.TwitterClient.like_tweet)
    * [get\_tweet\_replies](#spoon_ai.social_media.twitter.TwitterClient.get_tweet_replies)
    * [send](#spoon_ai.social_media.twitter.TwitterClient.send)
...
<a id="spoon_ai.social_media.discord"></a>

# Module `spoon_ai.social_media.discord`

<a id="spoon_ai.social_media.discord.DiscordClient"></a>
...
<a id="spoon_ai.social_media.discord.DiscordClient.__init__"></a>

#### `__init__`

```python
def __init__(agent: Optional[ToolCallAgent] = None)
```
...
<a id="spoon_ai.social_media.discord.DiscordClient.setup_handlers"></a>
...
<a id="spoon_ai.social_media.discord.DiscordClient.send"></a>
...
<a id="spoon_ai.social_media.discord.DiscordClient.run"></a>
...
<a id="spoon_ai.social_media.discord.DiscordClient.stop"></a>
...
<a id="spoon_ai.social_media.email"></a>

# Module `spoon_ai.social_media.email`

<a id="spoon_ai.social_media.email.EmailNotifier"></a>
...
<a id="spoon_ai.social_media.email.EmailNotifier.send"></a>
...
<a id="spoon_ai.social_media.telegram"></a>

# Module `spoon_ai.social_media.telegram`

<a id="spoon_ai.social_media.twitter"></a>

# Module `spoon_ai.social_media.twitter`

<a id="spoon_ai.social_media.twitter.TwitterClient"></a>

## `TwitterClient` Objects

```python
class TwitterClient()
```

<a id="spoon_ai.social_media.twitter.TwitterClient.read_timeline"></a>

#### `read_timeline`

```python
def read_timeline(count: int = None, **kwargs) -> list
```

Read tweets from the user's timeline

<a id="spoon_ai.social_media.twitter.TwitterClient.post_tweet"></a>

#### `post_tweet`

```python
def post_tweet(message: str, **kwargs) -> dict
```

Post a new tweet

<a id="spoon_ai.social_media.twitter.TwitterClient.reply_to_tweet"></a>

#### `reply_to_tweet`

```python
def reply_to_tweet(tweet_id: str, message: str, **kwargs) -> dict
```

Reply to an existing tweet

<a id="spoon_ai.social_media.twitter.TwitterClient.like_tweet"></a>

#### `like_tweet`

```python
def like_tweet(tweet_id: str, **kwargs) -> dict
```

Like a tweet

<a id="spoon_ai.social_media.twitter.TwitterClient.get_tweet_replies"></a>

#### `get_tweet_replies`

```python
def get_tweet_replies(tweet_id: str, count: int = 10, **kwargs) -> List[dict]
```

Fetch replies to a specific tweet

<a id="spoon_ai.social_media.twitter.TwitterClient.send"></a>

#### `send`

```python
def send(message: str, tags: Optional[List[str]] = None, **kwargs) -> bool
```
